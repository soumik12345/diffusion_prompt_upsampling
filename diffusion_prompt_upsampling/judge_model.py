...
class OpenAIPromptAlignmentJudgement(BaseModel):
    think_out_loud: str
    score: float
    judgement: str
...
class OpenAIJudgeModel(weave.Model):
    ...
    @weave.op()
    def predict(
        self, base_prompt: str, generated_image: str
    ) -> OpenAIPromptAlignmentJudgement:
        return self._openai_client.chat.completions.create(
            model=self.openai_model,
            response_model=OpenAIPromptAlignmentJudgement,
